        ...
        <div className="allProjects">
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              <div className="project_videocontainer">
                <div>
                  <img
                    src="https://i.imgur.com/nJWxFxt.png"
                    alt="Loading.."
                  />
                </div>
              </div>
          ...
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              <div className="project_videocontainer">
                <div>
                  <img
                    src="https://i.imgur.com/CNeRdyi.png"
                    alt="Loading..."
                  />
                </div>
              </div>
          ...
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              <div className="project_videocontainer">
                <div>
                  <img src="https://i.imgur.com/rEZ3zp0.png" alt="" />
                </div>
              </div>
              <div className="project_information">
                <h2>Loading..</h2>
          ...
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              <div className="project_videocontainer">
                <div>
                  <img
                    src="https://i.imgur.com/B7FFFJw.png"
                    alt=""
                  />
                </div>
              </div>
          ...
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              <div className="project_videocontainer">
                <div>
                  <img
                    src="https://i.imgur.com/h6spZsa.png"
                    alt="loading"
                  />
                </div>
              </div>
          ...
          <div className="projects_container" data-aos="fade-right">
            <div className="project">
              <div className="project_videocontainer">
                <div>
                  <img
                    src="https://i.imgur.com/fb24coU.png"
                    alt="PulsePlus-Clone"
                  />
                </div>
              </div>
